      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Video Follow-up</h2>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-2 items-start md:max-w-none lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl h-full">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Personalized Touch</h4>
              <p className="text-gray-600 text-center">Strengthen relationships by following up with clients using personalized video messages.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl h-full">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Memorable Impression</h4>
              <p className="text-gray-600 text-center">Stand out from the competition and make a lasting impression with video engagement.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl h-full">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Improved Conversion</h4>
              <p className="text-gray-600 text-center">Video follow-ups have been shown to increase lead conversion and customer loyalty.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl h-full">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Customizable CTA</h4>
              <p className="text-gray-600 text-center">Incorporate personalized calls-to-action to drive specific actions from your audience.</p>
            </div>
